...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">SHK HOTEL</a>
  ...
  <div class="card-body">
    ...
    <h6 calss="mb-4">Rs 200 per night</h6>
  ...
  <div class="card-body">
    <h5>Simple Room Name</h5>
    <h6 calss="mb-4">Rs 5000 per night</h6>
    <div class="features mb-4">
        <h6 class="mb-1">Features</h6>
        <span class="badge rounded-pill bg-light text-dark text-wrap lh-base">
                   2 Rooms
...
<div class="col-lg-4 col-md-3">
                <div class="card border-0 shadow" style="max-width: 350px; margin:auto;">
  <img src="images/rooms/8.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5>Simple Room Name</h5>
    <h6 calss="mb-4">Rs 1500 per night</h6>
    <div class="features mb-4">
        <h6 class="mb-1">Features</h6>
        <span class="badge rounded-pill bg-light text-dark text-wrap lh-base">
                   2 Rooms
    ...
    <a href="#" class="btn btn-sm btn-outline-dark shadow-none">More details</a>
                ...
                <div class="col-lg-12 text-center mt-5">
                    <a href="#" class="btn btn-sm btn-outline-dark rounded-o fw-bold shadow-none">More Rooms>>></a>
                </div>
